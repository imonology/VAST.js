...
function msg_handler(l_self_id, l_listen_port, l_local_IP, l_entry_servers, l_onDone) {
    ...
    var _visualComm = function (type,message, handler) {
        //console.log("visualComm => type: " + type);
        //console.log(message);
        //console.log(handler);
    ...
    _net = new VAST.net(_packetHandler, _connHandler, _disconnHandler, _visualComm, _clientComm, l_self_id, l_local_IP, l_entry_servers);
