...
var MOVEMENT_SPEED         = 0.25;     // the amount a client moves in a single movement frame
var MOVEMENT_FRAME          = 25;       // the amount of time between each movement interation for the visualiser
...
function VONPeer(l_aoi_buffer, l_aoi_use_strict) {
    ...
    var _insertNode = function (node) {
        ...
        _msg_handler.visualReturn(_voro.get_sites());
    ...
    var _deleteNode = function (id) {
        ...
        // finally, update voronoi diagram in visualiser
        _msg_handler.visualReturn(_voro.get_sites());
    ...
    var _updateNode = function (node) {
        ...
        // update visualiser voronoi diagram
        _msg_handler.visualReturn(_voro.get_sites());
