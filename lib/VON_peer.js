    ...
    var l_pointMessage = this.pointMessage = function(pointPacket){
        ...
        if (checklist.length > 0){
            ...
            for (var i = 0; i < checklist.length; i++){
                ...
                key = checklist[i]; //I know... strong types would be nice
...
*/
    ...
    var _startRecordingBandwidth = function(){
        recBandwidth.init(_self.id + '-bandwidth', _self.aoi.radius);
        ...
        setInterval(function(){
            ...
            _recordBandwidth(time, bpsSent, bpsReceived, mpsSent, mpsReceived);
    ...
    var _recordBandwidth = function(time, bpsSent, bpsReceived, mpsSent, mpsReceived){
        ...
        recBandwidth.write(state, _self.id + '-bandwidth');
    }
