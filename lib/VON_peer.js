...
function VONPeer(l_aoi_buffer, l_aoi_use_strict) {
    ...
    // public method used by matchers to send data to each other
    this.matcherMessage = function(pack, isReliable){
        _sendPack(pack, isReliable);
    }
    ...
    // Public accessors used by the matcher
