...
const CLIENT_THRESHOLD = 20;         // maximum number of clients that can be connected to the matcher
const SUB_THRESHOLD = 25;          // the maximum number of subscriptions before asking neighbours for help
