...
function entryServer (startPort) {
    ...
    var _loadBalanceShift = function (matcherID, en_list, pos) {
        console.log("shifting the balance of the matchers");
    ...
    var _getMovement = function(target, destination) {
        console.log("Getting movement of matcher");
        console.log(target);
    ...
    var _shiftMatcher = function (matcherID,pos) {
        console.log("Shifting matcher " + matcherID + " to position (" + pos.x + "," + pos.y + ")");
        ...
        console.log("Emitting movement to matcher");
    ...
    var initialiseListeners = function () {
        ...
        _io.on("connection", function(socket) {
            ...
            socket.on("ID", function (id, position) {
                console.log("ID received from matcher: " + id + " type: " + typeof id);
