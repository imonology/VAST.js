...
*/
    ...
    var _tick = function () {
        ...
        /*
        // only tick if not busy with previous step still
        if(now - _lastTick > 5000 || (_busyContactNew === false &&
            _busyCheckDiscovery === false &&
            _busyRemoveNonOverlapped === false)){
    ...
    //still busy with tick tasks?
    var _busyContactNew;
    var _busyCheckDiscovery;
    var _busyRemoveNonOverlapped;                      
