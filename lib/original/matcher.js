...
function VAST_matcher(recv_callback, msg_handler) {
    ...
    // join the matcher to the pub/sub layer
        ...
        */
        ...
        switch (pack.type) {
            ...
            case VAST.msgtype.JOIN: {
                ...
                // if origin matcher for the requested world exists, reply to the client
                else
                {
    ...
    // constructor
    //
    LOG.debug('matcher constructor called', -1);

    //
    //  connect with handler
    //

    var _msg_handler = msg_handler;
