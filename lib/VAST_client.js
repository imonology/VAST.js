...
function VASTClient(is_Client, host, port, radius, local_IP, x, y, entryServers) {
    ...
    // VON node definition
    var VONNode = function (isClient, GWaddr, radius, localIP, x, y, entryServers) {
    ...
    var vonPeer = new VONNode(is_Client, _addr, radius, local_IP, x, y, entryServers);
}
