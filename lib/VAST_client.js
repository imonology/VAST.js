...
function VASTClient(is_Client, host, port, radius, local_IP, x, y, entryServers, client_threshold, sub_threshold) {
    ...
    // VON node definition
    var VONNode = function (isClient, GWaddr, radius, localIP, x, y, entryServers, client_threshold, sub_threshold) {
        ...
        peer.init((isClient ? VAST.ID_UNASSIGNED : VAST.ID_GATEWAY), port, localIP, entryServers, function () {
            ...
            // a matcher unit
            var matcher = new VAST.matcher(vonPeer, client_threshold, sub_threshold);
    ...
    var vonPeer = new VONNode(is_Client, _addr, radius, local_IP, x, y, entryServers, client_threshold, sub_threshold);
}
