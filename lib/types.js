...
var l_area = exports.area = function (center, radius) {
    ...
    this.covers = function (pos) {
        ...
        return (this.center.distance(pos) <= (this.radius + pos.radius));
    }
...
var l_sub = exports.sub = function (host_id, id, channel, aoi, time) {
    ...
    this.subID     = this.host_id + "-" + this.id    // 'string' subscriptionID (different subscriptions may have same hostID)
    ...
    this.update = function (info) {
        ...
        this.subID   = this.host_id + "-" + this.id;
    ...
    // print out node info
    this.toString = function () {
        return '[' + this.subID + '] host_id: ' + this.host_id + ' clientID: ' + this.id + ' layer: ' + this.channel + ' AOI: ' + this.aoi.toString() + ' time: ' + this.time;
    }
}
