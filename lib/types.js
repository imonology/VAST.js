...
var l_pos = exports.pos = function (x, y) {
    ...
    this.equals = function (other_pos) {
        LOG.warn("This.x:"+this.x+" other_pos.x:"+other_pos.x+" this.y:"+this.y+" other_pos.y:"+other_pos.y);
...
var l_pack = exports.pack = function (type, msg, priority, sender, time ) {
...
var l_state = exports.clientState = function (id,time, position, neighbours, latMax, latMin, latAve, bandwidth) {
        this.id = id;
