...
var l_sub = exports.sub = function (host_id, id, channel, aoi, type, time) {
    ...
    // print out node info
    this.toString = function () {
        return '[' + this.subID + '] host_id: ' + this.host_id + ' clientID: ' + this.id + 'type: ' + this.type + ' layer: ' + this.channel + ' AOI: ' + this.aoi.toString() + ' time: ' + this.time;
    }
}
