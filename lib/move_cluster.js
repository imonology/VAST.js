...
var PROB_RANDOM_ATTRACTOR = 30;
var ATTRACTOR_SPACE_MULTIPLIER = 100;
...
var clusterMovement = function (topleft, bottomright, l_num_nodes, l_speed) {
    ...
    this.move = function () {
        ...
        for (var i=0; i < l_num_nodes; ++i) {
            ...
            _movement[i] = _movement[i] + ';' + _pos[i].x+','+_pos[i].y;
    ...
    // get the list of movements for the clients
    ...
    // adjust a coordinate to be within boundary
