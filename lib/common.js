...
global.Worker_Message = {
    ...
    POINT_MESSAGE_REC   : 3, // when matcher is sending point message with recipients
    AREA_MESSAGE        : 4 // when matcher is sending an area message to VON
} 
...
global.GS_Message = {
	MATCHER_JOIN : 0,
	VON_DATA : 1,		// only my id, pos, aoi, and voro 
	CLIENT_UPDATE : 2,
	SUB_UPDATE : 3,
    PUB_NEW : 4
}
