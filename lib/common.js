...
global.VON_Message = {
    ...
    MATCHER_FORWARD: 12 // Packets/Messages sent between matchers over VON peers' msg handler
};
...
global.Matcher_Message = {
    ...
    PUB_FORWARD:            2,      // Forwarding a publication to the accepting subscription's owner matcher
    PUB_NOTIFY:             3,      // Send overlapping publications to other matchers  
    SUB_OVERLAP:            4,      // Send overlapping matchers subscriptions that they must know about
    SUB_DISTANT:            5       // Send subscription to distant matcher, (center not in owner region)
};
